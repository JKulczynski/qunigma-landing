...
const faq = [
  ...
  },
  {
    ...
    a: 'Gotowe konektory (Splunk, Microsoft Sentinel, IBM QRadar) przyspieszają wdrożenie, ale integracja podstawowa działa przez standardowe REST API i webhook, niezależnie od konkretnego SIEM. Warto to doprecyzować w checkliście poniżej i podczas rozmowy technicznej.',
  },
  {
